...
let HomeController, scoreService, wordsService, $httpBackend, urlScores, urlWords, errorData, succDataScore, succDataWord, succDataWordMore;
...
describe('Home', () => {
    ...
    beforeEach(inject(function ($http, $filter, _$httpBackend_, $timeout) {
    
        scoreService = new ScoreService($http);
        wordsService = new WordsService($http, $filter);
        HomeController = new homeController(scoreService, wordsService, $filter, $scope, $timeout);
    ...
    it('nextWord function - values', () => {
        HomeController.userWord = 'dummy';
        HomeController.listOfWords = {testingData:[{value:'asd'},{value:'asd'}]};
