...
let ScoresController, $httpBackend, url, errorData, succData;

describe('Controller: ScoresController', () => {

    beforeEach(() => {
        angular.mock.inject(($controller, $rootScope) => {
            ScoresController = $controller('ScoresController', { $scope: $rootScope.$new() });
        });
    });
